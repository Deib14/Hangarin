...
from to_do.views import HomePageView, TaskList, TaskCreateView, TaskUpdateView, TaskDeleteView
from to_do.views import HomePageView, SubTaskList, SubTaskCreateView, SubTaskUpdateView, SubTaskDeleteView
from to_do.views import HomePageView, CategoryList, CategoryCreateView, CategoryUpdateView, CategoryDeleteView

from to_do.views import HomePageView, PriorityList, PriorityCreateView, PriorityUpdateView, PriorityDeleteView
from to_do.views import HomePageView, NoteList, NoteCreateView, NoteUpdateView, NoteDeleteView
